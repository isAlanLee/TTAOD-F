...
class SemiBaseDetector(BaseDetector):
    ...
    def __init__(self,
        ...
        student_detector = copy.deepcopy(detector) # detector会被修改
        teacher_detector = copy.deepcopy(detector)
        self.student = MODELS.build(student_detector)
        self.teacher = MODELS.build(teacher_detector)
